...
def main():
    ...
    #Finding the first open reading frame and translating it using get_all_translations
    rna_sequence = find_orf.find_first_orf(sequence)
    translated_seq = translate.get_all_translations(rna_sequence, genetic_code)
